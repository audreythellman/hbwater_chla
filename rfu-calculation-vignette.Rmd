...
- *Note: the HB WaTER slope information for 2022+ can be found at `raw data/chla_standardcurve_summary.xlsx`*
...
```
From here, you will get a list of the input files. Remember the number of the file you are going to clean. In this case, we are going to clean file #2 corresponding to 2020 data. 
...
1. check if your runs are labeled correctly (e.g. "run 2" vs. "run2") on the sample file and on the blanks dataframe
